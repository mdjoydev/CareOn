...
import 'patients_attendant_schedule_screen.dart';

class PatientsAttendantPackageScreen extends StatefulWidget {
  final bool isBangla;
  final PatientsAttendantBookingData bookingData;
  const PatientsAttendantPackageScreen({super.key, required this.isBangla, required this.bookingData});

  @override
  State<PatientsAttendantPackageScreen> createState() => _PatientsAttendantPackageScreenState();
}

class _PatientsAttendantPackageScreenState extends State<PatientsAttendantPackageScreen> {
  final Map<String, Map<String, Map<String, int>>> _prices = {
    'Daily': {
      'Basic Care': {'8 Hours': 1200, '12 Hours': 1600, '24 Hours': 2100},
      'Standard Care': {'8 Hours': 1800, '12 Hours': 2400, '24 Hours': 3200},
      'Critical Care': {'8 Hours': 2500, '12 Hours': 3500, '24 Hours': 4500},
    },
    'Monthly': {
      'Basic Care': {'8 Hours': 6500, '12 Hours': 8500, '24 Hours': 12500},
      'Standard Care': {'8 Hours': 12000, '12 Hours': 16000, '24 Hours': 22000},
      'Critical Care': {'8 Hours': 20000, '12 Hours': 28000, '24 Hours': 35000},
    }
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            PatientsAttendantStepIndicator(currentStep: 2),
                  ...
                  Expanded(
                    child: FilledButton(
                      onPressed: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => PatientsAttendantScheduleScreen(
