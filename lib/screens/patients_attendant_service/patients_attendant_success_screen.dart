...
class PatientsAttendantSuccessScreen extends StatelessWidget {
  final bool isBangla;
  final PatientsAttendantBookingData bookingData;

  const PatientsAttendantSuccessScreen({
    super.key,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                isBangla ? 'আমরা শীঘ্রই আপনাকে কল করব' : 'We Will Call You Soon',
                style: TextStyle(
              ...
              Text(
                isBangla 
                  ? 'আমাদের দল বর্তমানে আপনার কেসের জন্য সেরা উপলব্ধ অ্যাটেনডেন্ট নিয়োগ করছে। আপনি ১৫-৩০ মিনিটের মধ্যে একটি কল পাবেন।' 
                  : 'Our team is currently assigning the best available attendant to your case. You will receive a call within 15–30 minutes.',
              ...
              _buildSectionCard(
                ...
                children: [
                  _buildDetailRow(isBangla ? 'সেবা:' : 'Service:', bookingData.serviceName ?? "Patient's Attendant Service"),
              ...
              _buildSectionCard(
                ...
                children: [
                  ...
                  _buildStepItem(isBangla 
                    ? 'নিযুক্ত অ্যাটেনডেন্ট সময়সূচী এবং ঠিকানার বিবরণ নিশ্চিত করবেন' 
                    : 'The assigned attendant will confirm the schedule and address details'),
                  _buildStepItem(isBangla 
                    ? 'আপনার নির্বাচিত পদ্ধতি অনুযায়ী পেমেন্ট সংগ্রহ করা হবে' 
                    : 'Payment will be collected as per your selected method'),
                  _buildStepItem(isBangla 
                    ? 'সেবা শেষ হওয়ার পর, আপনার অভিজ্ঞতা রেটিং করুন' 
                    : 'After service completion, please rate your experience'),
                ],
              ),
              const SizedBox(height: 16),
              ...
              _buildSectionCard(
                ...
                children: [
                  ...
                  _buildNoteItem(isBangla 
                    ? 'অ্যাটেনডেন্টের জন্য প্রয়োজনীয় চিকিৎসা নথি প্রস্তুত রাখুন।' 
                    : 'Have necessary medical documents ready for the attendant.'),
                  _buildNoteItem(isBangla 
