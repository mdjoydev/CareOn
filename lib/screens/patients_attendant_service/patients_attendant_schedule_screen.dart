...
import 'patients_attendant_address_screen.dart';

class PatientsAttendantScheduleScreen extends StatefulWidget {
  final bool isBangla;
  final PatientsAttendantBookingData bookingData;
  const PatientsAttendantScheduleScreen({super.key, required this.isBangla, required this.bookingData});

  @override
  State<PatientsAttendantScheduleScreen> createState() => _PatientsAttendantScheduleScreenState();
}

class _PatientsAttendantScheduleScreenState extends State<PatientsAttendantScheduleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            PatientsAttendantStepIndicator(currentStep: 3),
                  ...
                  Expanded(
                    child: FilledButton(
                      onPressed: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (_) => PatientsAttendantAddressScreen(isBangla: widget.isBangla, bookingData: widget.bookingData)));
                      },
