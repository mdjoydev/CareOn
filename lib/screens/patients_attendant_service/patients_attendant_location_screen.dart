...
import 'patients_attendant_package_screen.dart';

class PatientsAttendantLocationScreen extends StatefulWidget {
  final bool isBangla;
  final PatientsAttendantBookingData bookingData;
  const PatientsAttendantLocationScreen({super.key, required this.isBangla, required this.bookingData});

  @override
  State<PatientsAttendantLocationScreen> createState() => _PatientsAttendantLocationScreenState();
}

class _PatientsAttendantLocationScreenState extends State<PatientsAttendantLocationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            PatientsAttendantStepIndicator(currentStep: 1),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget.isBangla ? 'সেবা প্রদানের জন্য সঠিক এলাকা নির্বাচন করুন' : 'Please choose the correct area for service delivery',
                      ...
                      children: _areas.map((area) {
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Icon(isSelected ? Icons.check_circle : Icons.circle_outlined, size: 18, color: isSelected ? CareOnApp.careOnGreen : Colors.grey.shade400),
                                const SizedBox(width: 10),
                                Expanded(child: Text(area, style: TextStyle(fontSize: 14, fontWeight: isSelected ? FontWeight.bold : FontWeight.w500, color: isSelected ? const Color(0xFF065F46) : const Color(0xFF374151)), overflow: TextOverflow.ellipsis)),
                              ],
                            ),
                          ),
                        );
                  ...
                  Expanded(
                    child: FilledButton(
                      onPressed: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (_) => PatientsAttendantPackageScreen(isBangla: widget.isBangla, bookingData: widget.bookingData)));
                      },
