...
import 'nursing_package_screen.dart';

class NursingLocationScreen extends StatefulWidget {
  final bool isBangla;
  final NursingBookingData bookingData;
  const NursingLocationScreen({super.key, required this.isBangla, required this.bookingData});

  @override
  State<NursingLocationScreen> createState() => _NursingLocationScreenState();
}

class _NursingLocationScreenState extends State<NursingLocationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            NursingStepIndicator(currentStep: 1),
                  ...
                  Expanded(
                    child: FilledButton(
                      onPressed: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (_) => NursingPackageScreen(isBangla: widget.isBangla, bookingData: widget.bookingData)));
                      },
