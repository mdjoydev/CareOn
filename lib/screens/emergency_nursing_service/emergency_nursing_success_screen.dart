...
class EmergencyNursingSuccessScreen extends StatelessWidget {
  final bool isBangla;
  final EmergencyNursingBookingData bookingData;

  const EmergencyNursingSuccessScreen({
    super.key,
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionCard(
                ...
                children: [
                  _buildDetailRow(isBangla ? 'সেবা:' : 'Service:', bookingData.serviceName ?? 'Emergency Nursing Service'),
