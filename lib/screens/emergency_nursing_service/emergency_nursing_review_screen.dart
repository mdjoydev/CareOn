...
import 'emergency_nursing_payment_screen.dart';

class EmergencyNursingReviewScreen extends StatefulWidget {
  final bool isBangla;
  final EmergencyNursingBookingData bookingData;

  const EmergencyNursingReviewScreen({
    super.key,
  ...
  @override
  State<EmergencyNursingReviewScreen> createState() => _EmergencyNursingReviewScreenState();
}

class _EmergencyNursingReviewScreenState extends State<EmergencyNursingReviewScreen> {
  bool _agreed = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          EmergencyNursingStepIndicator(currentStep: 5),
          Expanded(
            child: ListView(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 24),
                      _buildSummaryRow(
                        widget.isBangla ? 'সেবা:' : 'Service:', 
                        widget.bookingData.serviceName ?? 'Emergency Nursing Service'
                      ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: FilledButton(
              onPressed: _agreed 
                ? () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => EmergencyNursingPaymentScreen(isBangla: widget.isBangla, bookingData: widget.bookingData))) 
                : null,
