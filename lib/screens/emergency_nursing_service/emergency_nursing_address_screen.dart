...
import '../../main.dart';
import 'emergency_nursing_review_screen.dart';

class EmergencyNursingAddressScreen extends StatefulWidget {
  final bool isBangla;
  final String location;
  final EmergencyNursingBookingData bookingData;
  const EmergencyNursingAddressScreen({super.key, required this.isBangla, required this.location, required this.bookingData});

  @override
  State<EmergencyNursingAddressScreen> createState() => _EmergencyNursingAddressScreenState();
}

class _EmergencyNursingAddressScreenState extends State<EmergencyNursingAddressScreen> {
  ...
  void _onNext() {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) => EmergencyNursingReviewScreen(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.isBangla ? 'ঠিকানা এবং রোগীর তথ্য' : 'Address & Patient Information',
          style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold),
        ),
      ),
      body: Column(
        children: [
          EmergencyNursingStepIndicator(currentStep: 4),
          Expanded(
            child: Form(
              key: _formKey,
              child: ListView(
